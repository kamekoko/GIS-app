...
const minLon = Math.min(start[0], end[0]) - 0.05;
const maxLon = Math.max(start[0], end[0]) + 0.05;
const minLat = Math.min(start[1], end[1]) - 0.05;
const maxLat = Math.max(start[1], end[1]) + 0.05;
